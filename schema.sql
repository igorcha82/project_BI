...
CREATE TABLE IF NOT EXISTS Office (
    ...
    name        VARCHAR(16) NOT NULL     COMMENT 'Номер офиса',
...
CREATE INDEX IX_DocumentType_Id ON Document_Type(document_type);
ALTER TABLE Document_Type ADD FOREIGN KEY (document_type) REFERENCES Document(id);
